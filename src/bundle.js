...
/***/ function(module, exports, __webpack_require__) {
	...
	var Table = function (_React$Component) {
	  ...
	  _createClass(Table, [{
	    key: 'render',
	    value: function render() {
	      var times = [9, 9.5, 10, 10.5, 11, 11.5, 12, 12.5, 13, 13.5, 14, 14.5, 15, 15.5, 16, 16.5, 17, 17.5, 18, 18.5, 19, 19.5, 20, 20.5, 21, 21.5, 22, 22.5, 23, 23.5, 24];
	      return _react2.default.createElement(
	        'table',
	        { id: 'main' },
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'tr',
	            null,
	            _react2.default.createElement('td', { className: 'event', colspan: '8' })
	          ),
	          _react2.default.createElement(
	            'tr',
	            { className: 'top' },
	            _react2.default.createElement('td', { className: 'time' }),
	            _react2.default.createElement(
	              'td',
	              { className: 'top' },
	              _react2.default.createElement(
	                'a',
	                { className: 'day', href: '#SUN' },
	                'SUN'
	              )
	            ),
	            _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'a',
	                { className: 'day', href: '#FRI' },
	                'FRI'
	              )
	            )
	          ),
	          times.map(function (e) {
	            return _react2.default.createElement(_Row2.default, { key: e, time: e });
	          })
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Event = __webpack_require__(/*! ./Event.jsx */ 171);
	...
	var Row = function (_React$Component) {
	  ...
	  _createClass(Row, [{
	    key: 'eventsAtTime',
	    value: function eventsAtTime(day, time) {
	    ...
	    value: function render() {
	      ...
	      var events = days.map(function (day) {
	        var event = eventInfo[day][time];
	        var color = event && (colorInfo[event.color] || event.color);
	        var key = event && day + time + event.name;
	
	        return time in eventInfo[day] ? _react2.default.createElement(
	          'td',
	          { key: key, rowSpan: (event.end - time) * 2, onClick: function onClick() {
	              return handleClick(key);
	            } },
	          _react2.default.createElement(_Event2.default, { event: event, color: color, active: key === active })
	        ) : _this2.eventsAtTime(day, time).length === 0 && _react2.default.createElement('td', { key: day + time });
	      });
